            ...
            <section key={category.id} data-category={category.name}>
              <div className={`flex flex-col sm:flex-row justify-between items-start sm:items-center text-white p-3 sm:p-4 rounded-t-lg gap-2 sm:gap-3 ${category.brandColor || 'bg-gray-800'}`}>
                ...
                <div className="flex items-center gap-1 sm:gap-2">
                  <div className="flex items-center gap-1 sm:gap-2 bg-white/15 backdrop-blur-md border border-white/30 sm:border-2 px-2 sm:px-3 md:px-4 py-1.5 sm:py-2 rounded-lg sm:rounded-xl shadow-lg">
                    <svg className="w-3 h-3 sm:w-3.5 sm:h-3.5 md:w-4 md:h-4 text-green-400" fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24">
