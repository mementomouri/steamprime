...
export default async function HomePage() {
  ...
  return (
      ...
      <div className="max-w-7xl mx-auto p-3 sm:p-4 md:p-6 py-4 sm:py-6 md:py-8">
        <div className="bg-white/20 backdrop-blur-xl border border-white/30 rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-xl glass-box">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-4 sm:gap-6">
            {/* شماره تماس - بهینه شده برای موبایل */}
            <div className="flex items-center gap-3 sm:gap-4">
              <a 
                href="tel:28421523" 
                className="group flex items-center gap-2 sm:gap-3 bg-white/90 backdrop-blur-sm border-2 border-blue-500 px-3 sm:px-4 py-2 sm:py-2.5 rounded-lg sm:rounded-xl text-blue-700 hover:bg-blue-50 hover:scale-105 transition-all duration-200 shadow-lg hover:shadow-xl touch-friendly"
              >
                <svg className="w-4 h-4 sm:w-5 sm:h-5 text-blue-600 group-hover:text-blue-700 transition-colors duration-200" fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
                <span className="text-sm sm:text-base font-bold text-blue-800 tracking-wide">28421523</span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-4 gap-6 sm:gap-8 mb-8 sm:mb-12">
            ...
            <div className="space-y-4 sm:space-y-6">
              ...
              <div className="grid grid-cols-2 gap-3 sm:gap-4">
                {/* اینستاگرام */}
                <a href="https://instagram.com/mobile.tiger" target="_blank" rel="noopener noreferrer" className="flex flex-col items-center justify-center bg-gradient-to-br from-pink-500 to-purple-600 rounded-lg sm:rounded-xl p-3 sm:p-4 hover:scale-105 transition-all duration-200 shadow-lg hover:shadow-xl touch-friendly">
                ...
                {/* واتساپ */}
                <a href="https://wa.me/989124936146" target="_blank" rel="noopener noreferrer" className="flex flex-col items-center justify-center bg-gradient-to-br from-[#25D366] to-[#20BA5A] rounded-lg sm:rounded-2xl p-3 sm:p-4 hover:scale-105 transition-all duration-200 shadow-xl hover:shadow-2xl relative overflow-hidden touch-friendly">
                ...
                {/* تلفن */}
                <a href="tel:09121240465" className="flex flex-col items-center justify-center bg-gradient-to-br from-green-400 to-green-500 rounded-lg sm:rounded-2xl p-3 sm:p-4 hover:scale-105 transition-all duration-200 shadow-xl hover:shadow-2xl relative overflow-hidden touch-friendly">
                ...
                {/* تلگرام */}
                <a href="https://t.me/mehrad_tiger" target="_blank" rel="noopener noreferrer" className="flex flex-col items-center justify-center bg-gradient-to-br from-[#0088CC] to-[#0077B3] rounded-lg sm:rounded-2xl p-3 sm:p-4 hover:scale-105 transition-all duration-200 shadow-xl hover:shadow-2xl relative overflow-hidden touch-friendly">
